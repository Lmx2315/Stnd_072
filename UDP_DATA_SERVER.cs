...
namespace Stnd_072
{
    public class UDP_DATA_SERVER
    {
        ...
        FFTLibrary.Complex fft_z0 = new FFTLibrary.Complex();
        ...
        private void FFT_WORK0()
        {
            ...
            double[] windowedTimeSeries_i = new double[FFT_SIZE_MAX];
            double[] windowedTimeSeries_q = new double[FFT_SIZE_MAX];
              ...
              //          try
                        {
                            ...
                            windowScaleFactor = DSPLib.DSP.Window.ScaleFactor.Signal(wc);

                            (fft_array_x, fft_array_y) = DATA_TO_DBL(DATA0_i, DATA0_q, SIZE);
                            windowedTimeSeries_i = DSPLib.DSP.Math.Multiply(fft_array_y, wc);
                            windowedTimeSeries_q = DSPLib.DSP.Math.Multiply(fft_array_x, wc);
                            ...
                            fft_z0.FFT(1, k, windowedTimeSeries_i, windowedTimeSeries_q);
        ...
        FFTLibrary.Complex fft_z1 = new FFTLibrary.Complex();
                     ...
                     //   try 
                        {
                            ...
                            int k = Convert.ToInt16(LogBase(SIZE, 2));//порядок БПФ
                            fft_z1.FFT(1, k, windowedTimeSeries_i, windowedTimeSeries_q);
